...
public class YamlFileManager {
	private final Plugin plugin; // TODO

	public YamlFileManager(Plugin plugin) {
		this.plugin = plugin; // TODO
	}

	public YamlFile reloadYamlFile(YamlFile file) {
		loadFields(file, file, null);
		return file;
	}
	 ...
	 */
	private void loadFields(YamlFile file_object, Object parent, String parent_yaml_path) {
	...
	private void setField(Object dest_class_object, Field field, Object set_object) {
		if (dest_class_object == null || field == null || set_object == null) {
			throw new IllegalArgumentException("agrument is null.");
		}
		try {
